...
TRAINING_SAMPLE = os.environ['TRAINING_SAMPLE'] 
VALIDATE_SIZE = os.environ['VALIDATE_SIZE'] 
...
def iqr_mds_gan():
    ...
    df=df[['idx', 'Machine_Name','Additional_Info_1', 'Additional_Info_2','TimeStamp','Shot_Number',
